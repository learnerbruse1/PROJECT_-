...
import { FACILITY_TYPES, FACILITY_ORDER } from '../utils/geoUtils.js'

const layerItems = [
  { key: 'heatmap', label: '人口密度热力', dot: '#d7191c' },
  { key: 'school', label: '学校', dot: FACILITY_TYPES.school.color },
  { key: 'hospital', label: '医院', dot: FACILITY_TYPES.hospital.color },
  { key: 'park', label: '公园', dot: FACILITY_TYPES.park.color },
...
function resetRadius() {
  store.bufferRadius[store.analysisType] = null
}
</script>
  ...
  <div class="panel control-panel">
    ...
    <section class="block">
      ...
      <input
        ...
        @input="store.bufferRadius[store.analysisType] = Number($event.target.value)"
      />
    </section>
