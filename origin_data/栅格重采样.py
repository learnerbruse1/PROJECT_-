...
# 输入文件路径
WORLDPOP_RASTER = str(SCRIPT_DIR / "chn_ppp_2020_1km_Aggregated_UNadj.tif")
HONGSHAN_BOUNDARY = str(SCRIPT_DIR / "洪山区.shp")

# 输出配置
OUTPUT_FILE = str(SCRIPT_DIR / "hongshan_population.geojson")
